...
<?php include('send_msg.php') ?>
                   <?php if(isset($status)){?>
                   <center>
                        <div style='width:900px' class='<?php if(isset($class)){echo $class;} ?>'>
                    ...
                    <form action="contact.php" method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="card">
                            ...
                            <textarea name="msg" class="form-control" id="message" rows="20" required></textarea>
                        </div>
                        <div class="card">
                        <button type="submit" name="submit" class="btn btn-primary text-right">POST</button></div>
                    </form>
